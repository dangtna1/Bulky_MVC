...
namespace BulkyWeb.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult UpSert(ProductVM obj, IFormFile? file)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (file != null)
                {
                    ...
                    {
                        var oldProducPath = Path.Combine(wwwRootPath, obj.Product.ImageUrl.TrimStart('\\'));
                        if (System.IO.File.Exists(oldProducPath))
                        {
                            System.IO.File.Delete(oldProducPath);
                        }
                    }
        ...
        public IActionResult Delete(int id)
        {
            ...
            {
                return Json(new { success = false, message = "Product is not existed" });
            }
